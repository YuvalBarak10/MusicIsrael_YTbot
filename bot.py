...
def get_url(message):
	...
	try:
		...
		bot.send_audio(message.chat.id,audio,'🎵@MusicIsrael🎧','','ראשונים במוזיקה',mp3_file[6:-4],reply_to_message_id=message.message_id,thumb=open('rsz_img_20200510_015426_839.jpg', 'rb'))		
